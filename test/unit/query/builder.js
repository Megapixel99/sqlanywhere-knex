...
const clients = {
  ...
  sqlanywhere: new Sqlanywhere_Client({ client: 'sqlanywhere' }),
...
const clientsWithNullAsDefault = {
  ...
  sqlanywhere: new Sqlanywhere_Client(
    Object.assign({ client: 'sqlanywhere' }, useNullAsDefaultConfig)
  ),
...
const clientsWithCustomLoggerForTestWarnings = {
  ...
  sqlanywhere: new Sqlanywhere_Client(
    Object.assign({ client: 'sqlanywhere' }, customLoggerConfig)
  ),
  mssql: new MSSQL_Client(
